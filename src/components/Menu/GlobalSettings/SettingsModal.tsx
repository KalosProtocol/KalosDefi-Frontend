      ...
      <ScrollableContainer>
        ...
        <Flex justifyContent="space-between" alignItems="center" mb="24px">
          <Flex alignItems="center">
            <Text>{t('KalosZap(Beta)')}</Text>
            <QuestionHelper
              text={
                <Box>
                  <Text>
                    {t(
                      'KalosZap enables simple liquidity provision. Add liquidity with one token and one click, without manual swapping or token balancing.',
                    )}
                  </Text>
                  <Text>
                    {t('If you experience any issue when adding or removing liquidity, please disable KalosZap and retry.')}
                  </Text>
                </Box>
              }
              placement="top-start"
