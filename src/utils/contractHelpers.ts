...
import xaloAbi from 'config/abi/cake.json'
...
import xaloFlexibleSideVaultV2Abi from 'config/abi/xaloFlexibleSideVaultV2.json'
...
import iXaloAbi from 'config/abi/iXalo.json'
...
export const getXaloFlexibleSideVaultV2Contract = (signer?: Signer | Provider) => {
  return getContract(xaloFlexibleSideVaultV2Abi, getXaloFlexibleSideVaultAddress(), signer) as XaloFlexibleSideVaultV2
}
...
export const getIfoCreditAddressContract = (signer?: Signer | Provider) => {
  return getContract(iXaloAbi, getIXaloAddress(), signer) as IXalo
}
