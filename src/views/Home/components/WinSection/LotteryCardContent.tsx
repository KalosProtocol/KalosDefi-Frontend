...
const LotteryCardContent = () => {
  ...
  const xaloPrizesText = t('%xaloPrizeInUsd% in XALO prizes this round', { xaloPrizeInUsd: xaloPriceBusd.toString() })
  const [pretext, prizesThisRound] = xaloPrizesText.split(xaloPriceBusd.toString())
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="white" mb="40px">
          {t('Buy tickets with XALO, win XALO if your numbers match')}
        </Text>
      </Flex>
