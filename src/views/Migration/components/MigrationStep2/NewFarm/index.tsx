...
import { useFarms, usePriceXaloBusd, usePollFarmsWithUserData } from 'state/farms/hooks'
...
const OldFarmStep1: React.FC = () => {
  ...
  const rowData = chosenFarmsMemoized.map((farm) => {
    ...
    const lpLabel = farm.lpSymbol && farm.lpSymbol.split(' ')[0].toUpperCase().replace('KALOSDEFI', '')
