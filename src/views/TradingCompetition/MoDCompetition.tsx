...
const MoDCompetition = () => {
  ...
  const { hasUserClaimed, isUserActive, userXaloRewards, userDarRewards, userPointReward, canClaimNFT } =
  ...
  const userCanClaimPrizes =
    ...
    isUserActive &&
    !hasUserClaimed &&
    (userXaloRewards !== '0' || userDarRewards !== '0' || userPointReward !== '0' || canClaimNFT)
    ...
    const fetchUserContract = async () => {
      try {
        ...
        const userObject: UserTradingInformation = {
          ...
          userXaloRewards: user[4].toString(),
